...
class StreakCalculator {
  ...
  int calculateDaily(List<bool> completedStates) =>
      _calculateStreak(completedStates);

  int calculateWeekly(List<bool> completedStates) =>
      _calculateStreak(completedStates);

  int calculateMonthly(List<bool> completedStates) =>
      _calculateStreak(completedStates);
